...
import com.example.ativpontuada.service.ClienteService;
...
public class ClienteController {
    ...
    public ResponseEntity<Map<String,Object>>atualizar(@PathVariable Long id,@RequestBody ClienteModel cliente){
        clienteService.atualizarClientes(id, cliente);
        return ResponseEntity.status(HttpStatus.OK).body(Map.of("mensagem","Dados do Cliente alterados com sucesso!!"));
    }
